...
public class MovementBehavior extends TickerBehaviour {
    ...
    protected void onTick() {
        /*
         * TODO 1: zorg dat de beweging van de smiley om de minuut verandert, gebruik initMove() en de super
         */
        try {
            if (!registered) {
                register();
    ...
    private void move() throws CodecException, OntologyException {
        ...
        if (doMove(n)) {
            ...
            /*
             * TODO 2: zorg dat de smiley uit de yellow pages verdwijnt en stopt met bewegen, gebruik DFService en de super
             */
        }
    }
